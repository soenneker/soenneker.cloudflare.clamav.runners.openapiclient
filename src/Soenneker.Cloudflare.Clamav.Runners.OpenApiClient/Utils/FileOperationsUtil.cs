...
using Soenneker.Cloudflare.Clamav.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Cloudflare.Clamav.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Clamav:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/soenneker/soenneker.cloudflare.clamav.openapi/main/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Clamav OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "CloudflareClamavOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
